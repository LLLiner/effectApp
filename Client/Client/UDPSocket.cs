...
namespace Client
{
    class UDPSocket
    {
        ...
        static public ulong maxDelayLimit = 10000000000;
        ...
        public static void startReceive()
        {
            ...
            {
                localIpep = new IPEndPoint(IPAddress.Parse(MainWindows.srcIp), 8899); //本机IP和监听端口号
                            ...
                            */
                            ...
                            using (MySqlConnection connection = new MySqlConnection(conStr))
                            {
                                try
                                {
                                    ...
                                    if(MainWindows.wifi == false)
                                    {
                                        cmd.Parameters.AddWithValue("@delay", delayInt * 8 / 1000.0); //us
                                    }
                                    else
                                    {
                                        cmd.Parameters.AddWithValue("@delay", delayInt * 8 / 1000000.0); // ms
                                    }
